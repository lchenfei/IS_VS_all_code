...
samples = cell(1,n_exp);
responses = cell(1,n_exp);
...
parfor i = 1:n_exp
    disp(i)
    [final_est_list(i), bandwidth_info{i}, weight_info{i}, weightv_info{i}, samples{i}, responses{i}, v_list{i}] = WAMK_SIS(target_quantile_, N_T_, LoadType_, i);
