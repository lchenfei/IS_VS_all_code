#' GP-VS Method for Importance Sampling Variable Selection - Example 4
#' 
#' Uses Gaussian Process with greedy CE ordering and validation-based subset selection (D=50).
#'
