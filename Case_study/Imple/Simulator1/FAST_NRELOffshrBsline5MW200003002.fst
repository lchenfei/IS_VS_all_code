...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
  0.00     BlPitch(1)  - Blade 1 initial pitch (degrees) 
  0.00     BlPitch(2)  - Blade 2 initial pitch (degrees) 
  0.00     BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades] 
  0.00     B1PitchF(1) - Blade 1 final pitch for pitch maneuvers (degrees) 
  0.00     B1PitchF(2) - Blade 2 final pitch for pitch maneuvers (degrees) 
  0.00     B1PitchF(3) - Blade 3 final pitch for pitch maneuvers (degrees) [unused for 2 blades] 
...
---------------------- INITIAL CONDITIONS --------------------------------------
   ...
   0.0      Azimuth     - Initial azimuth angle for blade 1 (degrees)
       6.9643   	RotSpeed    - Initial or fixed rotor speed (rpm)
...
---------------------- TOWER ---------------------------------------------------
  10	!JASON:SHOULD I CHANGE THIS TO 20 FOR THE ANALYSIS???        TwrNodes    - Number of tower nodes used for analysis (-)
...
---------------------- AERODYN -------------------------------------------------
"NRELOffshrBsline5MW_AeroDyn200003002.ipt"       ADFile      - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
"RootMxb1 , RootMyb1"                            			 - In-plane bending, out-of-plane bending moments at the root of blade 1
